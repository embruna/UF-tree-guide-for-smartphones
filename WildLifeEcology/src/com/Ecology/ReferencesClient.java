...
public class ReferencesClient extends Thread {
	private static String TAG = "MyActivity";
	private String mFileName;// = "TreeData.txt";
	private String mUrl;
	private References mActivity;
	...
	public void setActivity(References activity) {
		mActivity = activity;
	}
    ...
    private void getTreeNames() {
        ...
        try {
			...
			try {
				...
				fs.close();
				mActivity.setReferencesFileDownloaded(true);
			} catch (IOException e) {
				e.printStackTrace();
			}
